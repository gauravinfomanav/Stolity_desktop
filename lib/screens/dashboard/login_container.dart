...
class Login_conatiner extends StatefulWidget {
  final VoidCallback? signUpTapCallback;
  const Login_conatiner({super.key, this.signUpTapCallback});

  @override
  State<Login_conatiner> createState() => _Login_conatinerState();
}

class _Login_conatinerState extends State<Login_conatiner> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: Get.height * 0.02),
            GestureDetector(
              onTap: widget.signUpTapCallback,
              child: RichText(
                text: TextSpan(
